...
// dummyData
import menus from '@/dummyData/menu.json';
    ...
    return (
        <div className={`${style.gnb_wrap} ${scroll ? style.scroll : ''}`}>
            <div className={`pc_gnb flex_between ${style.pc_gnb} `}>
                                ...
                                return (
                                    <li key={menu.menuId}>
                                        ...
                                        <div className={style.depth_2_box}>
                                            <ul
                                                className={`flex_start ${style.depth_2}`}
                                            >
                                                {menus
                                                    .filter(
                                                        (
                ...
                <ul
                    className={`flex_start ${style.right}`}
                    data-aos="fade-left"
                >
                    {menus.map((menu: MenusType) => {
            ...
            <button
                ...
                className={`mo_gnb_hamburger ${style.mo_gnb_hamburger} ${
                    moGnbOpen
                        ? style.mo_gnb_hamburger_open
                        : style.mo_gnb_hamburger_close
                }`}
                onClick={() => {
